  ...
  aiPresetPrompts: [
    {
      ...
      name: "📋 简报",
      enabled: false,
      prompt: `**输出规范**: 直接输出结果，不需要前缀说明或总述性文字。

将这篇新闻总结成结构化内容。组织成以下类别：关键决策、涉及人物、数据要点、待观察问题。保持总结简洁专业。表格输出。

注意：数据要点按照按照矛盾和冲突剧烈性排序`
    },
    {
      id: "data",
      name: "📊 数据总结",
...
你是一位顶级应用经济学与金融学期刊的资深学术编辑。请将这篇文章转化为结构严谨的实证研究框架。
